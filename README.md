...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\policy-kms-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\policy-kms-keys)
...
- Outbound (depends on): "encryption_policies", "kms_keys"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package policy-kms-keys -Apply
