...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\policy-kms-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\policy-kms-keys) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package policy-kms-keys -Apply
