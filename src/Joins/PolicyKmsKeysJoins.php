...
namespace BlackCat\Database\Packages\PolicyKmsKeys\Joins;
 ...
 */
final class PolicyKmsKeysJoins {
    ...
    /**
     * FK: policy_kms_keys -> encryption_policies
