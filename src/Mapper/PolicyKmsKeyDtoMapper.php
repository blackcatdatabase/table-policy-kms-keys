...
namespace BlackCat\Database\Packages\PolicyKmsKeys\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO PolicyKmsKeyDto:
...
final class PolicyKmsKeyDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'policy_id' => 'policyId', 'kms_key_id' => 'kmsKeyId', 'weight' => 'weight', 'priority' => 'priority', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'policy_id', 'kms_key_id', 'weight', 'priority' ];
    /** @var string[] */
     ...
     * @return PolicyKmsKeyDto
     */
    public static function fromRow(array $row): PolicyKmsKeyDto
    {
        /** @var PolicyKmsKeyDto */
        return DtoHydrator::fromRow(
            PolicyKmsKeyDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?PolicyKmsKeyDto
    {
     ...
     *
     * @param PolicyKmsKeyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PolicyKmsKeyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PolicyKmsKeyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PolicyKmsKeyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PolicyKmsKeyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PolicyKmsKeyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PolicyKmsKeyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PolicyKmsKeyDto>
     */
