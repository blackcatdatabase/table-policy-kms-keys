...
final class PolicyKmsKeysModule implements ModuleInterface
{
    public function name(): string { return 'table-policy_kms_keys'; }
    public function table(): string { return 'policy_kms_keys'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-encryption_policies', 'table-kms_keys' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_policy_kms_keys_key', 'fk_policy_kms_keys_policy' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_policy_kms_keys_key', 'fk_policy_kms_keys_policy' ],
        ];
    }
}
