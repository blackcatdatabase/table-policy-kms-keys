...
{
    private PolicyKmsKeyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PolicyKmsKeyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyKmsKeys\Dto\PolicyKmsKeyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PolicyKmsKeys\Dto\PolicyKmsKeyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyKmsKeys\Dto\PolicyKmsKeyDto|null
    {
