...
use BlackCat\Database\Packages\PolicyKmsKeys\Repository\PolicyKmsKeyRepository as GeneratedRepository;
...
{
  private PolicyKmsKeyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PolicyKmsKeyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PolicyKmsKeyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyKmsKeys\Dto\PolicyKmsKeyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyKmsKeys\Dto\PolicyKmsKeyDto|null { return $this->repo->getById($id, $asDto); }
